...
public class WSClient extends WebSocketClient {
    ...
    private void parsePacket(ByteBuffer bytes) throws IOException {
		...
		case 0x0:{
			...
			byte[] dat = new byte[5];
			dat[0] = (byte) ClientToServer.CTS_ITEM.getValue();
		...
		case 0x4:{
		    Client.strictHash = (data[0] != 0);
		    Lobby.addToLog(String.format("[#] bms hash is %s.", Client.strictHash ? "enforced" : "not enforced"));
		    return;
		}
		case 0x5:
		case 0x6:
